...
const GomezMedicalRoutes = {
  ...
  routes: [
    ...
    {
      exact: true,
      path: PATH_APP.purchasing.orders.verifyPrices,
      component: lazy(() => import('../views/gomezmedical/purchasing/orders/PurchaseOrderShowEditPrices'))
    },
    {
      exact: true,
      path: PATH_APP.purchasing.orders.makePayment,
      component: lazy(() => import('../views/gomezmedical/purchasing/orders/PurchaseOrderMakePayment'))
    },
    {
      exact: true,
